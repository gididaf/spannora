...
- Context-window denominator comes from `SDKResultMessage.modelUsage[<model>].contextWindow`. Sum `usage.input_tokens + cache_read_input_tokens + cache_creation_input_tokens` for the numerator.
